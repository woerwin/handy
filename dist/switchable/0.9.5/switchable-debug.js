define("#switchable/0.9.5/switchable-debug", ["#zepto/1.0.0/zepto-debug", "#widget/0.9.16/widget-mobile-debug", "#base/0.9.16/base-debug", "#class/0.9.2/class-debug", "#events/0.9.1/events-debug", "#base/0.9.16/aspect-debug", "#base/0.9.16/attribute-debug", "#widget/0.9.16/daparser-mobile-debug", "#widget/0.9.16/auto-render-mobile-debug", "#switchable/0.9.5/const-debug", "#switchable/0.9.5/plugins/effects-debug", "#switchable/0.9.5/plugins/autoplay-debug", "#switchable/0.9.5/plugins/circular-debug", "#switchable/0.9.5/plugins/multiple-debug"], function(require, exports, module) {
...
define("#switchable/0.9.5/plugins/autoplay-debug", ["#zepto/1.0.0/zepto-debug"], function(require, exports, module) {
...
define("#switchable/0.9.5/plugins/effects-debug", ["#zepto/1.0.0/zepto-debug"], function(require, exports, module) {
    ...
    module.exports = {
        ...
        install: function() {
            ...
            if (effect.indexOf('scroll') === 0) {
                ...
                if (!viewSize[0]) {
                    viewSize[0] = firstPanel.get(0).offsetWidth * step;
                    viewSize[1] = firstPanel.get(0).offsetHeight * step;
...
define("#switchable/0.9.5/plugins/circular-debug", ["#zepto/1.0.0/zepto-debug", "#switchable/0.9.5/plugins/effects-debug"], function(require, exports, module) {
    ...
    Effects.scrollCircular = function(panelInfo) {
        ...
        if (this.anim) {
            // zepto 没有 stop 方法
            // 因为 zepto 使用的是 css3 动画，而 css3 的动画暂没有提供 stop 函数
            // 后续考虑添加

define("#dialog/0.9.0/animDialog-debug", ["#zepto/0.9.0/zepto-debug", "#overlay/0.9.1/overlay-debug", "#position/0.9.0/position-debug", "#android-shim/0.9.0/android-shim-debug", "#widget/0.9.16/widget-mobile-debug", "#base/0.9.16/base-debug", "#class/0.9.2/class-debug", "#events/0.9.1/events-debug", "#base/0.9.16/aspect-debug", "#base/0.9.16/attribute-debug", "#widget/0.9.16/daparser-mobile-debug", "#widget/0.9.16/auto-render-mobile-debug", "#dialog/0.9.0/baseDialog-debug", "#overlay/0.9.1/mask-debug"], function(require, exports, module) {

    var $ = require("#zepto/0.9.0/zepto-debug"),
        Overlay = require("#overlay/0.9.1/overlay-debug"),
        BaseDialog = require("#dialog/0.9.0/baseDialog-debug");

...
define(function (require){
    ...
    describe('Storage',function (){
        it('Make sure Storage has get,set,clearAll,available,remove,clear,on,off and trigger method.',function (){
            var methods = 'get,set,available,on,off,trigger,remove,keys,clear'.split(',');
        ...
        it('remove method is correct calling.',function (){
            Storage.set('handy',true);

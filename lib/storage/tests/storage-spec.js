...
define(function (require){
    ...
    describe('Storage',function (){
        it('Make sure Storage has get,set,clearAll,available,delete,on,off and trigger method.',function (){
            var methods = 'get,set,available,on,off,trigger,delete,keys'.split(',');
        ...
        it('delete method is correct calling.',function (){
            Storage.set('handy',true);
            Storage.delete('handy')
            var keys = Storage.keys();

define(function(require, exports) {
    ...
    function normalize(posObject) {
        ...
        result.size = function() {
            ...
            /*return {
                width: numberize(el.css('width')) + //outer.margin.left +
                       //outer.margin.right +
                       outer.padding.left +
                       outer.padding.right +
                       outer.borderWidth.left +
                       outer.borderWidth.right,
                height: numberize(el.css('height')) + //outer.margin.top +
                        //outer.margin.bottom +
                        outer.padding.top +
                        outer.padding.bottom +
                        outer.borderWidth.top +
                        outer.borderWidth.bottom
            };*/
        };

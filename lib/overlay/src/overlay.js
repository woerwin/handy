...
define(function(require, exports, module) {
    ...
    var Overlay = Base.extend({
        ...
        addShim: function() {
            ...
            var shim = $('<div data-overlay-role="shim" style="position:absolute;' +
                         'margin:0;padding:0;border:none;background:rgba(255,255,255,0.01);-webkit-tap-highlight-color:rgba(0,0,0,0);' +

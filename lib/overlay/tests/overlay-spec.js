    ...
    describe('Overlay',function (){
        beforeEach(function (){
            instance = new Overlay({
                element: '<div class="test">Overlay test.'+
                         '</div>',
                parent: '#J-abc'
            });
            instance.render();
        ...
        it('Make sure element rendered to $(\'body\')',function (){
           expect($('#J-abc').find('.test')[0]).toBeTruthy();
        });
    });
});
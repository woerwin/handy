...
define(function (require){
    ...
    describe('Overlay',function (){
        ...
        it('Should has on,off,trigger,initialize,render,sync,destroy,show,hide,setCSS,addShim methods.',function (){
            spyOn(instance,'on');
            ...
            spyOn(instance,'setCSS');
            expect(instance.setCSS).not.toHaveBeenCalled();

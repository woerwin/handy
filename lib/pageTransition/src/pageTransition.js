...
define(function(require, exports, module) {
    ...
    PageTransition.prototype.sync = function() {
        var container = $(this.options.element),
            containerW = container.get(0).offsetWidth,
            pages = this.viewport
    ...
    PageTransition.prototype._transitionForward = function() {
        ...
        transitionX.call(
                    this,
                    -parseInt($(this.options.element).css('width'),10),
    ...
    PageTransition.prototype._transitionBack = function() {
        ...
        var width = parseInt($(this.options.element).css('width'));
        setViewPortXTo.call(this,-width, 10);
        transitionX.call(
            this,
            0,
    ...
    function transitionX(width,callback){
        if(this.options.effect === null){
            this.options.duration = 0;
            this.options.effect = 'margin';
        }
        ...
        if(this.options.effect !== 'transition'){
            css = {
                marginLeft: width
            }
        }

        this.viewport.animate(css,this.options.duration, null, $.proxy(function() {
            callback.call(this);
        },this));
    }

    function setViewPortXTo(val){
        var xVal = val || 0;

        var css = {
            '-webkit-transform': "translateX("+xVal+"px)"
        };
        ...
        // 此时 viewport中只有一个页面，因此需要设置 viewport 的 水平方向的滚动值为0

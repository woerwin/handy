        ...
        _startFlip:function() {
            ...
            switch (this.get("direction")) {
                case "ltr":
                    switch (this.face) {
                        case "front":
                            this._startCSS = { "-webkit-transform":"rotate(180deg)"};
                            this._endCSS = {"-webkit-transform":"rotate(0deg)"};
                            break;
                        case "back":
                        default:
                            this._startCSS = { "-webkit-transform":"rotate(0deg)"};
                            this._endCSS = {"-webkit-transform":"rotate(180deg)"};
                            break;
